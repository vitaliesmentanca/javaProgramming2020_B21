...
public class UnaryOperators {
    public static void main(String[] args) {
        ...
        int a = 100;
        boolean pozitive = a > 0;
        boolean negative = a < 0;
        System.out.println(a + " is pozitive " + pozitive);
...
//pre
        int z = 100;
        System.out.println(--z); //99 pre decrement instant

        int x2 = 100;
        System.out.println(++x2); // 101 pre increment instant
