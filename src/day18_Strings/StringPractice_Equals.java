...
public class StringPractice_Equals {
    public static void main(String[] args) {
        ...
        System.out.println(s1 == s3 ); //false because is create new memory location
        ...
        // .equals()
        System.out.println( s1.equals(s3) ); // true compare only the word
        ...
        // last index: 5 just number not letter
        ...
        char lastChar = a.charAt( a.length()-1 );//or minus2 ...-2
        //       last index num of a
